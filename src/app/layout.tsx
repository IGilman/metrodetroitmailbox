...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Brighton mailbox installation",
    "Howell mailbox installation",
    "Ann Arbor mailbox installation",
    "Ypsilanti mailbox installation",
    "Oakland County mailbox service",
    "Macomb County mailbox installation",
    "Wayne County mailbox installation",
    "Livingston County mailbox installation",
